...
fn regression_49_predictions() {
    ...
    // Hardcoded reference values (50-digit precision, captured 2026-02-22)
    let expected: &[(&str, f64)] = &[
        ...
        // #5: m_e
        ("m_e", 5.109740402604931e-1),
        // #6: m_μ
        ("m_μ", 1.056542637585243e2),
        // #7: m_τ
        ("m_τ", 1.776898345471456e3),
        // #8: m_u
        ("m_u", 2.207042894153781e0),
        // #9: m_c
        ("m_c", 1.264513385366838e3),
        // #10: m_t
        ("m_t", 1.725024484437401e5),
        // #11: m_d
        ("m_d", 4.636000021394996e0),
        // #12: m_s
        ("m_s", 9.254320165285233e1),
        // #13: m_b
        ("m_b", 4.139713860683795e3),
        // #14: Σ_lep
        ("Σ_lep", 1.883063583270241e3),
        // #15: Σ_up
        ("Σ_up", 1.737691688720011e5),
        // #16: Σ_down
        ("Σ_down", 4.236893062358043e3),
        // #17: Σ_ν
        ("Σ_ν", 5.856807214039605e1),
        // #18: V_ud
        ("V_ud", 9.744658225139561e-1),
        // #19: V_us
        ("V_us", 2.245065229378004e-1),
        // #20: V_ub
        ("V_ub", 3.630690096652636e-3),
        // #21: V_cd
        ("V_cd", 2.243757195523468e-1),
        // #22: V_cs
        ("V_cs", 9.736042102722986e-1),
        // #23: V_cb
        ("V_cb", 4.183752162139054e-2),
        // #24: V_td
        ("V_td", 8.479223287875785e-3),
        // #25: V_ts
        ("V_ts", 4.112982978851963e-2),
        // #26: V_tb
        ("V_tb", 9.991178308257749e-1),
        // #27: δ_CKM
        ("δ_CKM", 6.428571428571429e1),
        // #28: J (Jarlskog)
        ("J (Jarlskog)", 2.991151747134548e-5),
        // #29: sin²θ₁₂
